...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20240812_mywp_23f30fe35bf52e8d8396_20240812071726_archive.zip';
        const ARCHIVE_SIZE       = '97178522';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '23f30fe-12071726';
        const SECONDARY_PACKAGE_HASH = '8a5fd11-12071726';
        const VERSION            = '1.5.10.2';
